...
$ADMIN_MENU_BLOCK = <<<'PHPBLOCK'
            ...
            [
                ...
                [
                    'text' => getPaySettingValue('statusfrenzyex', 'offfrenzyex') === 'onfrenzyex'
                        ? $textbotlang['Admin']['Status']['statuson']
                        : $textbotlang['Admin']['Status']['statusoff'],
                    'callback_data' => "editpayment-frenzyex-" . getPaySettingValue('statusfrenzyex', 'offfrenzyex'),
                ],
...
$ADMIN_TOGGLE_BLOCK = <<<'PHPBLOCK'
    // >>> FRENZYEX GATEWAY — installed by install.sh, do not edit inside these markers
        ...
        if ($value !== 'onfrenzyex' && (!$fx_api_ready || !$fx_secret_ready)) {
            update("PaySetting", "ValuePay", "offfrenzyex", "NamePay", "statusfrenzyex");
            sendmessage(
                $from_id,
            ...
            $valuenew = $value === 'onfrenzyex' ? 'offfrenzyex' : 'onfrenzyex';
...
// >>> FRENZYEX GATEWAY — installed by install.sh, do not edit inside these markers
    ...
    $fx_api_ready = !in_array(trim((string) getPaySettingValue('apifrenzyex', '')), ['', '0'], true);
    $fx_secret_ready = !in_array(trim((string) getPaySettingValue('secretfrenzyex', '')), ['', '0'], true);
    $fx_status = getPaySettingValue('statusfrenzyex', 'offfrenzyex') === 'onfrenzyex' ? 'روشن ✅' : 'خاموش ❌';
...
$TARGETS = [
    ...
    'admin.php' => [
        'patches' => [
            ...
            [
                'anchor' => "                ['text' => \$textbotlang['keyboard']['settings'], 'callback_data' => \"startelegram\"],",
