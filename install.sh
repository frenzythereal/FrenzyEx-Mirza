...
#    curl -o install.sh -L https://raw.githubusercontent.com/FrenzyExBot/mirzabot/main/install.sh && bash install.sh
#
#  Supported: Mirza Bot 0.4 and 0.4.1
#
#  Two of the bot's own files are edited — index.php and keyboard.php — and both
#  are backed up first. Every edit sits between markers and option 6 removes
...
REPO_RAW="${FRENZY_REPO_RAW:-https://raw.githubusercontent.com/FrenzyExBot/mirzabot/main}"
...
install_gateway() {
  ...
  info "ویرایش index.php و keyboard.php ..."
